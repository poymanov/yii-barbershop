...
<?=$this->render('cartModal');?>

<?php
    if (Yii::$app->getSession()->hasFlash('successConfirm')) {
        echo $this->render('userModalConfirmEmail',['confirmText' => Yii::$app->getSession()->getFlash('successConfirm')]);
    } elseif (Yii::$app->getSession()->hasFlash('errorConfirm')) {
        echo $this->render('userModalConfirmEmail',['confirmText' => Yii::$app->getSession()->getFlash('errorConfirm')]);
    }
?>
